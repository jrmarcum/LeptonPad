...
**What is true now, in one paragraph.** LeptonPad is a Deno 2.x browser PWA at **v2.3.30**
...
`tests/` suite of 80 steps runs as part of `deno task check`. Identity is Clerk; roles, license codes, and section-pack ownership live in
...
| [roadmap.md](roadmap.md)                       | Where the project stands at **v2.3.30 (2026-09-23)**, the 14-release math/notation session and the 11-release test-and-unit-correctness session summarised, and what is queued — the `WASM-READY` markers, the section-pack storefront, and what is deliberately not being built.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
