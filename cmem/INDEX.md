...
| [blocks.md](blocks.md)                         | The nine block types, what each does, the stretch/resize handle matrix, section blocks and variable scoping (`beam1__L`), summary blocks (section-only and pro+), and custom modules (multi-block user tools).                                                                                                                                                                                                                                                                                                              |
