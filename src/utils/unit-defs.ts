...
export const UNIT_CATEGORIES: Record<string, UnitCategory> = {
  ...
  // ---- Length (base: m) ---------------------------------------------------
  length: {
    id: 'length', label: 'Length', siBase: 'm',
    units: [
  ...
  area: {
    ...
    units: [
      ...
      { id: 'mi2',  label: 'Square Miles',       symbol: 'mi²',  factor: 2589988.110336, system: 'english' },
    ],
  },

  // ---- Volume (base: m³) --------------------------------------------------
  volume: {
    id: 'volume', label: 'Volume', siBase: 'm³',
    units: [
      ...
      { id: 'gal',  label: 'Gallons (US)',        symbol: 'gal',   factor: 3.785411784e-3,     system: 'english' },
      { id: 'qt',   label: 'Quarts (US)',         symbol: 'qt',    factor: 9.46352946e-4,      system: 'english' },
      { id: 'floz', label: 'Fluid Ounces (US)',   symbol: 'fl oz', factor: 2.95735295625e-5,   system: 'english' },
    ],
  },

  // ---- Mass (base: kg) ----------------------------------------------------
  mass: {
    id: 'mass', label: 'Mass', siBase: 'kg',
    units: [
  ...
  temperature: {
    id: 'temperature', label: 'Temperature', siBase: 'K',
    units: [
      ...
      { id: 'F', label: 'Fahrenheit', symbol: '°F', factor: 5 / 9,   offset: 255.37222222222222,  system: 'english' },
  ...
  forcePerUnitLength: {
    ...
    units: [
      ...
      { id: 'plf',  label: 'Pounds-force per foot',    symbol: 'plf',  factor: 14.593902937206,   system: 'english' },
      { id: 'kip_ft',  label: 'Kips per foot',            symbol: 'kip/ft',  factor: 14593.902937206,   system: 'english' },
      { id: 'klf',  label: 'Kips per foot',            symbol: 'klf',  factor: 14593.902937206,   system: 'english' },
  ...
  // ---- Angle (base: rad) --------------------------------------------------
  angle: {
    id: 'angle', label: 'Angle', siBase: 'rad',
    units: [
  ...
  angular_acceleration: {
    id: 'angular_acceleration', label: 'Angular Acceleration', siBase: 'rad/s²',
    units: [
      ...
      { id: 'rpm_s',   label: 'RPM per second',    symbol: 'rpm/s',   factor: 2 * _PI / 60,        system: 'both' },
      { id: 'rpm_min', label: 'RPM per minute',    symbol: 'rpm/min', factor: 2 * _PI / 3600,      system: 'both' },
    ],
  },
  ...
  area_moi: {
    id: 'area_moi', label: 'Area Moment of Inertia (Second Moment of Area)', siBase: 'm⁴',
    units: [
  ...
  section_modulus: {
    id: 'section_modulus', label: 'Section Modulus', siBase: 'm³',
    units: [
  ...
  warping_constant: {
    id: 'warping_constant', label: 'Torsional Warping Constant', siBase: 'm⁶',
    units: [
